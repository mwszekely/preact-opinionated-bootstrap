import { forwardElementRef, TagSensitiveProps } from "../props";
...
type SimpleProps<E extends EventTarget, I extends keyof h.JSX.HTMLAttributes<E>> = Pick<h.JSX.HTMLAttributes<E>, keyof GlobalAttributes<E> | I>;
