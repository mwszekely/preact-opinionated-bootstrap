 ...
 */
export const GridResponsive = forwardElementRef(function ResponsiveGrid<E extends Element>({ tag, minWidth, children, ...props }: { minWidth: `${string}em` } & Partial<TagSensitiveProps<E>> & GlobalAttributes<E>, ref: Ref<E>) {
    return (
 ...
 */
export const GridStatic = forwardElementRef(function ResponsiveGrid<E extends Element>({ tag, columns, children, ...props }: { columns: number | string } & Partial<TagSensitiveProps<E>> & GlobalAttributes<E>, ref: Ref<E>) {
    return (
