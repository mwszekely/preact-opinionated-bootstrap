(function () {
    ...
    */
    ...
    function useLinearNavigation({
      ...
      const navigateToIndex = A$1(index => {
      ...
      const navigateToStart = A$1(() => {
        navigateToIndex(0);
      }, [navigateToIndex]);
      const navigateToEnd = A$1(() => {
        navigateToIndex(-1);
      }, [navigateToIndex]);
        ...
        return (v$1("div", { class: "demo" },
            v$1(Card, null,
                ...
                v$1(CardElement, null,
                    ...
                    v$1("ul", null,
                        v$1("li", null,
                            "The child component must pass its ref and all unused props to ",
                            v$1("strong", null, "its"),
                            " child component."),
                        v$1("li", null,
                            "The child component must be a ref-forwarding component.  Use ",
                            v$1("code", null, "forwardElementRef"),
                            " (or just the built-in ",
                            v$1("code", null, "forwardRef"),
                            ") to do this."),
                        v$1("li", null,
                            "The child component must be stable (as in, it's not an anonymous function defined on each render).  If the child component is just a plain ol' global function like most, this isn't an issue.  If it's defined inside a component, make sure it's wrapped in ",
