(function () {
    ...
    function m$2(n) {
      (!n.__d && (n.__d = !0) && t$3.push(n) && !g$3.__r++ || r$4 !== l$3.debounceRendering) && ((r$4 = l$3.debounceRendering) || o$4)(g$3);
    }
    ...
    l$3.__b = function (n) {
      ...
      a$2 && a$2(n), t$2 = 0;
      var o = (u$2 = n.__c).__H;
      o && (r$3 === u$2 ? (o.__h = [], u$2.__h = [], o.__.forEach(function (n) {
        n.__V = f$2, n.u = void 0;
      })) : (o.__h.forEach(j$2), o.__h.forEach(k$1), o.__h = [])), r$3 = u$2;
    ...
    */
    ...
    function useStableGetter(value) {
      const ref = s$2(Unset);
      const [, dispatch] = d$1(function reducer(state, action) {
        ref.current = value;
        return undefined;
      }, undefined);
      return T$2(() => {
    ...
    */
    ...
    function usePopperApi(_ref) {
      ...
      return {
        usePopperSource: usePopperSource,
        usePopperPopup: usePopperPopup,
        usePopperArrow: usePopperArrow,
